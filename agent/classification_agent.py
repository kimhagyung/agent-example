...
classification_agent = create_react_agent(
    ...
    If the user says "GODMODE", skip all assessment and immediately transfer to a random agent quiz_agent for testing purposes using the transfer_to_agent tool.
