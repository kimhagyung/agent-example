...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"final": {"type": "listen", "trigger_methods": ["second", "third"], "trigger_condition_type": "AND", "condition_type": "AND", "trigger_condition": {"type": "AND", "conditions": ["second", "third"]}, "method_signature": {"operationId": "final", "parameters": {}, "returns": {}}, "source_code": "    @listen(and_(second, third)) # second\uc640 third\uac00 \ub05d\ub098\uae38 \uae30\ub2e4\ub9bc \n    def final(self):\n        print(\":)\")\n", "source_lines": ["    @listen(and_(second, third)) # second\uc640 third\uac00 \ub05d\ub098\uae38 \uae30\ub2e4\ub9bc \n", "    def final(self):\n", "        print(\":)\")\n"], "source_start_line": 25, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}, "first": {"type": "start", "method_signature": {"operationId": "first", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def first(self):\n        print('Hello')\n", "source_lines": ["    @start()\n", "    def first(self):\n", "        print('Hello')\n"], "source_start_line": 12, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}, "second": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "second", "parameters": {}, "returns": {}}, "source_code": "    @listen(first) # first\ub77c\ub294 function\uc758 \uc885\ub8cc\ub97c listen\ud55c\ub2e4. \n    def second(self):\n        print('world')\n", "source_lines": ["    @listen(first) # first\ub77c\ub294 function\uc758 \uc885\ub8cc\ub97c listen\ud55c\ub2e4. \n", "    def second(self):\n", "        print('world')\n"], "source_start_line": 16, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}, "third": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "third", "parameters": {}, "returns": {}}, "source_code": "    @listen(first)\n    def third(self):\n        print(\"!\")\n", "source_lines": ["    @listen(first)\n", "    def third(self):\n", "        print(\"!\")\n"], "source_start_line": 20, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}};
...
class NetworkManager {
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"final": {"type": "listen", "trigger_methods": ["second", "third"], "trigger_condition_type": "AND", "condition_type": "AND", "trigger_condition": {"type": "AND", "conditions": ["second", "third"]}, "method_signature": {"operationId": "final", "parameters": {}, "returns": {}}, "source_code": "    @listen(and_(second, third)) # second\uc640 third\uac00 \ub05d\ub098\uae38 \uae30\ub2e4\ub9bc \n    def final(self):\n        print(\":)\")\n", "source_lines": ["    @listen(and_(second, third)) # second\uc640 third\uac00 \ub05d\ub098\uae38 \uae30\ub2e4\ub9bc \n", "    def final(self):\n", "        print(\":)\")\n"], "source_start_line": 25, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}, "first": {"type": "start", "method_signature": {"operationId": "first", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def first(self):\n        print('Hello')\n", "source_lines": ["    @start()\n", "    def first(self):\n", "        print('Hello')\n"], "source_start_line": 12, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}, "second": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "second", "parameters": {}, "returns": {}}, "source_code": "    @listen(first) # first\ub77c\ub294 function\uc758 \uc885\ub8cc\ub97c listen\ud55c\ub2e4. \n    def second(self):\n        print('world')\n", "source_lines": ["    @listen(first) # first\ub77c\ub294 function\uc758 \uc885\ub8cc\ub97c listen\ud55c\ub2e4. \n", "    def second(self):\n", "        print('world')\n"], "source_start_line": 16, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}, "third": {"type": "listen", "trigger_methods": ["first"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "third", "parameters": {}, "returns": {}}, "source_code": "    @listen(first)\n    def third(self):\n        print(\"!\")\n", "source_lines": ["    @listen(first)\n", "    def third(self):\n", "        print(\"!\")\n"], "source_start_line": 20, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class MyFirstFlow(Flow)", "class_line_number": 10, "class_name": "MyFirstFlow"}}, "edges": [{"source": "first", "target": "second", "condition_type": "OR", "is_router_path": false}, {"source": "first", "target": "third", "condition_type": "OR", "is_router_path": false}, {"source": "second", "target": "final", "condition_type": "AND", "is_router_path": false}, {"source": "third", "target": "final", "condition_type": "AND", "is_router_path": false}], "start_methods": ["first"], "router_methods": []};
