...
class NodeRenderer {
  ...
  drawNodeShape(ctx, x, y, width, height, scale, nodeStyle, opacity = 1.0, node = null) {
    ...
    const isDarkMode = document.documentElement.getAttribute('data-theme') === 'dark';
    const nodeData = {"check_seo": {"type": "listen", "trigger_methods": ["handle_make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "check_seo", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"handle_make_blog\")    \n    def check_seo(self):\n        print(\"Checking log SEO..\")\n", "source_lines": ["    @listen(\"handle_make_blog\")    \n", "    def check_seo(self):\n", "        print(\"Checking log SEO..\")\n"], "source_start_line": 77, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "check_virality": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["handle_make_tweet", "handle_make_linkedin_post"]}, "trigger_methods": ["handle_make_tweet", "handle_make_linkedin_post"], "method_signature": {"operationId": "check_virality", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n    def check_virality(self):\n        print(\"Checking virality...\")\n", "source_lines": ["    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n", "    def check_virality(self):\n", "        print(\"Checking virality...\")\n"], "source_start_line": 81, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "conduct_research": {"type": "listen", "trigger_methods": ["init_content_pipeline"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research", "parameters": {}, "returns": {}}, "source_code": "    @listen(init_content_pipeline)\n    def conduct_research(self):  # \uc704\uc758 \uac12\uc5d0 \ub300\ud574 ? \uc870\uc0ac\uc911\uc778 \ud568\uc218 (\ub9ac\uc11c\uce58\ud06c\ub8e8)\n        print('Researching...')\n        return True\n", "source_lines": ["    @listen(init_content_pipeline)\n", "    def conduct_research(self):  # \uc704\uc758 \uac12\uc5d0 \ub300\ud574 ? \uc870\uc0ac\uc911\uc778 \ud568\uc218 (\ub9ac\uc11c\uce58\ud06c\ub8e8)\n", "        print('Researching...')\n", "        return True\n"], "source_start_line": 43, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "conduct_research_router": {"type": "router", "is_router": true, "router_paths": ["make_linkedin_post", "make_tweet", "make_blog"], "trigger_methods": ["conduct_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research_router", "parameters": {}, "returns": {}}, "source_code": "    @router(conduct_research)\n    def conduct_research_router(self):\n        content_type = self.state.content_type\n\n        if content_type == \"blog\":\n            return \"make_blog\"\n        elif content_type == \"tweet\":\n            return \"make_tweet\"\n        else:\n            return \"make_linkedin_post\"\n", "source_lines": ["    @router(conduct_research)\n", "    def conduct_research_router(self):\n", "        content_type = self.state.content_type\n", "\n", "        if content_type == \"blog\":\n", "            return \"make_blog\"\n", "        elif content_type == \"tweet\":\n", "            return \"make_tweet\"\n", "        else:\n", "            return \"make_linkedin_post\"\n"], "source_start_line": 48, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "finalize_content": {"type": "listen", "trigger_methods": ["check_passed"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "finalize_content", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"check_passed\")\n    def finalize_content(self):\n        print(\"Finalizing content\")\n", "source_lines": ["    @listen(\"check_passed\")\n", "    def finalize_content(self):\n", "        print(\"Finalizing content\")\n"], "source_start_line": 101, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "handle_make_blog": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_blog", "remake_blog"]}, "trigger_methods": ["make_blog", "remake_blog"], "method_signature": {"operationId": "handle_make_blog", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_blog\", \"remake_blog\"))   #\uac01 \ubcc0\uc218\uc5d0 \ub300\ud55c \ub9ac\uc2a4\ub108 \n    def handle_make_blog(self):\n        # if blog post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        print(\"Making blog post...\")\n", "source_lines": ["    @listen(or_(\"make_blog\", \"remake_blog\"))   #\uac01 \ubcc0\uc218\uc5d0 \ub300\ud55c \ub9ac\uc2a4\ub108 \n", "    def handle_make_blog(self):\n", "        # if blog post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        print(\"Making blog post...\")\n"], "source_start_line": 59, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "handle_make_linkedin_post": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_linkedin_post", "remake_linkedin_post"]}, "trigger_methods": ["make_linkedin_post", "remake_linkedin_post"], "method_signature": {"operationId": "handle_make_linkedin_post", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_linkedin_post\",\"remake_linkedin_post\"))    \n    def handle_make_linkedin_post(self):\n        # if linkedin_post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        print(\"Making linkedin post...\")\n", "source_lines": ["    @listen(or_(\"make_linkedin_post\",\"remake_linkedin_post\"))    \n", "    def handle_make_linkedin_post(self):\n", "        # if linkedin_post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        print(\"Making linkedin post...\")\n"], "source_start_line": 71, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "handle_make_tweet": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_tweet", "remake_tweet"]}, "trigger_methods": ["make_tweet", "remake_tweet"], "method_signature": {"operationId": "handle_make_tweet", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_tweet\",\"remake_tweet\"))    \n    def handle_make_tweet(self):\n        # if blog tweet\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        print(\"Making tweet...\")\n", "source_lines": ["    @listen(or_(\"make_tweet\",\"remake_tweet\"))    \n", "    def handle_make_tweet(self):\n", "        # if blog tweet\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        print(\"Making tweet...\")\n"], "source_start_line": 65, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "init_content_pipeline": {"type": "start", "method_signature": {"operationId": "init_content_pipeline", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def init_content_pipeline(self):   #state\ub97c \uac80\uc99d\ud558\ub294 \n        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n            raise ValueError(\"The content type is wrong\")    \n\n        if self.state.topic  == \"\":\n            raise ValueError(\"The topic can't be blank.\")\n\n        if self.state.content_type == \"tweet\":\n            self.state.max_length = 150\n        elif self.state.content_type == \"blog\":\n            self.state.max_length  = 800\n        elif self.state.content_type == \"linkedin\":\n            self.state.max_length = 500\n", "source_lines": ["    @start()\n", "    def init_content_pipeline(self):   #state\ub97c \uac80\uc99d\ud558\ub294 \n", "        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n", "            raise ValueError(\"The content type is wrong\")    \n", "\n", "        if self.state.topic  == \"\":\n", "            raise ValueError(\"The topic can't be blank.\")\n", "\n", "        if self.state.content_type == \"tweet\":\n", "            self.state.max_length = 150\n", "        elif self.state.content_type == \"blog\":\n", "            self.state.max_length  = 800\n", "        elif self.state.content_type == \"linkedin\":\n", "            self.state.max_length = 500\n"], "source_start_line": 28, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "score_router": {"type": "router", "is_router": true, "router_paths": ["check_passed", "remake_linkedin_post", "remake_blog", "remake_tweet"], "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["check_seo", "check_virality"]}, "trigger_methods": ["check_seo", "check_virality"], "method_signature": {"operationId": "score_router", "parameters": {}, "returns": {}}, "source_code": "    @router(or_(check_seo, check_virality))\n    def score_router(self):\n        content_type = self.state.content_type\n        score = self.state.score\n\n        if score >= 8:\n            return \"check_passed\"\n        else:\n            if content_type == \"blog\":\n                return \"remake_blog\"\n            elif content_type == \"linkedin\":\n                return \"remake_linkedin_post\"\n            else:\n                return \"remake_tweet\"\n", "source_lines": ["    @router(or_(check_seo, check_virality))\n", "    def score_router(self):\n", "        content_type = self.state.content_type\n", "        score = self.state.score\n", "\n", "        if score >= 8:\n", "            return \"check_passed\"\n", "        else:\n", "            if content_type == \"blog\":\n", "                return \"remake_blog\"\n", "            elif content_type == \"linkedin\":\n", "                return \"remake_linkedin_post\"\n", "            else:\n", "                return \"remake_tweet\"\n"], "source_start_line": 85, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}};
...
class NetworkManager {
  ...
  setupExportControls() {
    ...
    //   const dagData = {"nodes": {"check_seo": {"type": "listen", "trigger_methods": ["handle_make_blog"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "check_seo", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"handle_make_blog\")    \n    def check_seo(self):\n        print(\"Checking log SEO..\")\n", "source_lines": ["    @listen(\"handle_make_blog\")    \n", "    def check_seo(self):\n", "        print(\"Checking log SEO..\")\n"], "source_start_line": 77, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "check_virality": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["handle_make_tweet", "handle_make_linkedin_post"]}, "trigger_methods": ["handle_make_tweet", "handle_make_linkedin_post"], "method_signature": {"operationId": "check_virality", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n    def check_virality(self):\n        print(\"Checking virality...\")\n", "source_lines": ["    @listen(or_(handle_make_tweet, handle_make_linkedin_post))\n", "    def check_virality(self):\n", "        print(\"Checking virality...\")\n"], "source_start_line": 81, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "conduct_research": {"type": "listen", "trigger_methods": ["init_content_pipeline"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research", "parameters": {}, "returns": {}}, "source_code": "    @listen(init_content_pipeline)\n    def conduct_research(self):  # \uc704\uc758 \uac12\uc5d0 \ub300\ud574 ? \uc870\uc0ac\uc911\uc778 \ud568\uc218 (\ub9ac\uc11c\uce58\ud06c\ub8e8)\n        print('Researching...')\n        return True\n", "source_lines": ["    @listen(init_content_pipeline)\n", "    def conduct_research(self):  # \uc704\uc758 \uac12\uc5d0 \ub300\ud574 ? \uc870\uc0ac\uc911\uc778 \ud568\uc218 (\ub9ac\uc11c\uce58\ud06c\ub8e8)\n", "        print('Researching...')\n", "        return True\n"], "source_start_line": 43, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "conduct_research_router": {"type": "router", "is_router": true, "router_paths": ["make_linkedin_post", "make_tweet", "make_blog"], "trigger_methods": ["conduct_research"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "conduct_research_router", "parameters": {}, "returns": {}}, "source_code": "    @router(conduct_research)\n    def conduct_research_router(self):\n        content_type = self.state.content_type\n\n        if content_type == \"blog\":\n            return \"make_blog\"\n        elif content_type == \"tweet\":\n            return \"make_tweet\"\n        else:\n            return \"make_linkedin_post\"\n", "source_lines": ["    @router(conduct_research)\n", "    def conduct_research_router(self):\n", "        content_type = self.state.content_type\n", "\n", "        if content_type == \"blog\":\n", "            return \"make_blog\"\n", "        elif content_type == \"tweet\":\n", "            return \"make_tweet\"\n", "        else:\n", "            return \"make_linkedin_post\"\n"], "source_start_line": 48, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "finalize_content": {"type": "listen", "trigger_methods": ["check_passed"], "trigger_condition_type": "OR", "condition_type": "OR", "method_signature": {"operationId": "finalize_content", "parameters": {}, "returns": {}}, "source_code": "    @listen(\"check_passed\")\n    def finalize_content(self):\n        print(\"Finalizing content\")\n", "source_lines": ["    @listen(\"check_passed\")\n", "    def finalize_content(self):\n", "        print(\"Finalizing content\")\n"], "source_start_line": 101, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "handle_make_blog": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_blog", "remake_blog"]}, "trigger_methods": ["make_blog", "remake_blog"], "method_signature": {"operationId": "handle_make_blog", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_blog\", \"remake_blog\"))   #\uac01 \ubcc0\uc218\uc5d0 \ub300\ud55c \ub9ac\uc2a4\ub108 \n    def handle_make_blog(self):\n        # if blog post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        print(\"Making blog post...\")\n", "source_lines": ["    @listen(or_(\"make_blog\", \"remake_blog\"))   #\uac01 \ubcc0\uc218\uc5d0 \ub300\ud55c \ub9ac\uc2a4\ub108 \n", "    def handle_make_blog(self):\n", "        # if blog post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        print(\"Making blog post...\")\n"], "source_start_line": 59, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "handle_make_linkedin_post": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_linkedin_post", "remake_linkedin_post"]}, "trigger_methods": ["make_linkedin_post", "remake_linkedin_post"], "method_signature": {"operationId": "handle_make_linkedin_post", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_linkedin_post\",\"remake_linkedin_post\"))    \n    def handle_make_linkedin_post(self):\n        # if linkedin_post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        print(\"Making linkedin post...\")\n", "source_lines": ["    @listen(or_(\"make_linkedin_post\",\"remake_linkedin_post\"))    \n", "    def handle_make_linkedin_post(self):\n", "        # if linkedin_post\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        print(\"Making linkedin post...\")\n"], "source_start_line": 71, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "handle_make_tweet": {"type": "listen", "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["make_tweet", "remake_tweet"]}, "trigger_methods": ["make_tweet", "remake_tweet"], "method_signature": {"operationId": "handle_make_tweet", "parameters": {}, "returns": {}}, "source_code": "    @listen(or_(\"make_tweet\",\"remake_tweet\"))    \n    def handle_make_tweet(self):\n        # if blog tweet\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n        print(\"Making tweet...\")\n", "source_lines": ["    @listen(or_(\"make_tweet\",\"remake_tweet\"))    \n", "    def handle_make_tweet(self):\n", "        # if blog tweet\uac00 \uc774\ubc88\uc5d0 \ub9cc\ub4e4\uc5b4\uc9c4\uc801\uc774 \uc788\ub294\uc9c0 \ud655\uc778\ud558\uace0 \uadf8\ub807\ub2e4\uba74 \uc608\uc804 \uac83\uc744 ai\uc5d0\uac8c \ubcf4\uc5ec\uc918\uc57c \ud55c\ub2e4 .\uadf8\ub9ac\uace0 \uadf8\uac83\uc744 \uac1c\uc120\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        # else \uc774\uc804\uc5d0 \uc0dd\uc131\ub41c \u3153\u3148\u3131\uc774 \uc5c6\ub2e4\uba74 \uadf8\ub0e5 \uc0dd\uc131\ud574\ub2ec\ub77c\uace0 \uc694\uccad\n", "        print(\"Making tweet...\")\n"], "source_start_line": 65, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "init_content_pipeline": {"type": "start", "method_signature": {"operationId": "init_content_pipeline", "parameters": {}, "returns": {}}, "source_code": "    @start()\n    def init_content_pipeline(self):   #state\ub97c \uac80\uc99d\ud558\ub294 \n        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n            raise ValueError(\"The content type is wrong\")    \n\n        if self.state.topic  == \"\":\n            raise ValueError(\"The topic can't be blank.\")\n\n        if self.state.content_type == \"tweet\":\n            self.state.max_length = 150\n        elif self.state.content_type == \"blog\":\n            self.state.max_length  = 800\n        elif self.state.content_type == \"linkedin\":\n            self.state.max_length = 500\n", "source_lines": ["    @start()\n", "    def init_content_pipeline(self):   #state\ub97c \uac80\uc99d\ud558\ub294 \n", "        if self.state.content_type not in [\"tweet\", \"blog\", \"linkedin\"]:\n", "            raise ValueError(\"The content type is wrong\")    \n", "\n", "        if self.state.topic  == \"\":\n", "            raise ValueError(\"The topic can't be blank.\")\n", "\n", "        if self.state.content_type == \"tweet\":\n", "            self.state.max_length = 150\n", "        elif self.state.content_type == \"blog\":\n", "            self.state.max_length  = 800\n", "        elif self.state.content_type == \"linkedin\":\n", "            self.state.max_length = 500\n"], "source_start_line": 28, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}, "score_router": {"type": "router", "is_router": true, "router_paths": ["check_passed", "remake_linkedin_post", "remake_blog", "remake_tweet"], "trigger_condition_type": "OR", "condition_type": "OR", "trigger_condition": {"type": "OR", "conditions": ["check_seo", "check_virality"]}, "trigger_methods": ["check_seo", "check_virality"], "method_signature": {"operationId": "score_router", "parameters": {}, "returns": {}}, "source_code": "    @router(or_(check_seo, check_virality))\n    def score_router(self):\n        content_type = self.state.content_type\n        score = self.state.score\n\n        if score >= 8:\n            return \"check_passed\"\n        else:\n            if content_type == \"blog\":\n                return \"remake_blog\"\n            elif content_type == \"linkedin\":\n                return \"remake_linkedin_post\"\n            else:\n                return \"remake_tweet\"\n", "source_lines": ["    @router(or_(check_seo, check_virality))\n", "    def score_router(self):\n", "        content_type = self.state.content_type\n", "        score = self.state.score\n", "\n", "        if score >= 8:\n", "            return \"check_passed\"\n", "        else:\n", "            if content_type == \"blog\":\n", "                return \"remake_blog\"\n", "            elif content_type == \"linkedin\":\n", "                return \"remake_linkedin_post\"\n", "            else:\n", "                return \"remake_tweet\"\n"], "source_start_line": 85, "source_file": "/mnt/c/Users/gkrud/Documents/content-pipeline-agent/main.py", "class_signature": "class ContentPipelineFlow(Flow[ContentPipelineState])", "class_line_number": 26, "class_name": "ContentPipelineFlow"}}, "edges": [{"source": "init_content_pipeline", "target": "conduct_research", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_blog", "target": "check_seo", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_tweet", "target": "check_virality", "condition_type": "OR", "is_router_path": false}, {"source": "handle_make_linkedin_post", "target": "check_virality", "condition_type": "OR", "is_router_path": false}, {"source": "conduct_research", "target": "conduct_research_router", "condition_type": "OR", "is_router_path": false}, {"source": "check_seo", "target": "score_router", "condition_type": "OR", "is_router_path": false}, {"source": "check_virality", "target": "score_router", "condition_type": "OR", "is_router_path": false}, {"source": "conduct_research_router", "target": "handle_make_linkedin_post", "condition_type": null, "is_router_path": true, "router_path_label": "make_linkedin_post"}, {"source": "conduct_research_router", "target": "handle_make_tweet", "condition_type": null, "is_router_path": true, "router_path_label": "make_tweet"}, {"source": "conduct_research_router", "target": "handle_make_blog", "condition_type": null, "is_router_path": true, "router_path_label": "make_blog"}, {"source": "score_router", "target": "finalize_content", "condition_type": null, "is_router_path": true, "router_path_label": "check_passed"}, {"source": "score_router", "target": "handle_make_linkedin_post", "condition_type": null, "is_router_path": true, "router_path_label": "remake_linkedin_post"}, {"source": "score_router", "target": "handle_make_blog", "condition_type": null, "is_router_path": true, "router_path_label": "remake_blog"}, {"source": "score_router", "target": "handle_make_tweet", "condition_type": null, "is_router_path": true, "router_path_label": "remake_tweet"}], "start_methods": ["init_content_pipeline"], "router_methods": ["conduct_research_router", "score_router"]};
