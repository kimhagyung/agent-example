...
<br>
<b>OPENAI_API_KEY = "API_KEY" </b>  # openai(https://platform.openai.com/settings/organization/api-keys)에서 로그인 후  발급(**모델 사용에 따른 비용 추가 발생**) <br>
...
- 요새 ai가 많아져 위 프로젝트에서 수행하는 크롤링이 막힐 수도있음
